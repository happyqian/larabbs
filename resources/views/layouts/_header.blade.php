<nav class="navbar navbar-default navbar-static-top">
    <div class="container">
        <div class="navbar-header">
            <!-- Collapsed Hamburger -->
            <button:button class="navbar-toggle collapsed" data-toggle="collapse" data-target="#app-navbar-collapse">
                ...
                @else
                    ...
                    <li>
                        <a href="{{ route('notifications.index') }}" class="notifications-badge" style="margin-top:-2px;">
                            <span class="badge badge-{{ Auth::user()->notification_count > 0 ? 'hint' : 'fade' }}" title="消息通知">
